<script lang="ts">
	let { fill = 'white', cssclass = '' } = $props();
</script>


<svg class={cssclass} {fill} height="100%" width="100%" version="1.1" id="Icons" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
